...
const SEARCHED_1 = 'rgb(122, 116, 251, 0.8)'
const SEARCHED_2 = 'rgb(89, 136, 238, 0.7)'
const SEARCHED_3 = 'rgb(103, 195, 238, 0.6)'
const SEARCHED_4 = 'rgb(238, 237, 238, 1)'
const SEARCHES = [SEARCHED_1, SEARCHED_2, SEARCHED_3, SEARCHED_4]
const START = '#69d885'
const END = '#d95353'
const EMPTY = '#ffffff'
const WALL = 'rgba(244,244,244, 0.9)'
const BEST_PATH_1 = 'rgb(87, 43, 229,0.6)'
const BEST_PATH_2 = 'rgba(43, 85, 229, 0.7)'
const TO_SEARCH = 'rgb(255, 255, 255, 0.8)'
            ...
            <div className="welcome-wrapper">
                <div className="welcome-header">
                    <div className="social-links">
                        <img src="/images/linkedInBlue.png" onClick={this.imgClick.bind(this, "https://www.linkedin.com/in/ttkremer/")}></img>
                        <img src="/images/githubBlue.png" onClick={this.imgClick.bind(this, "https://github.com/TeedsK")}></img>
                        <img src="/images/twitterBlue.png" onClick={this.imgClick.bind(this, "https://twitter.com/TeedsTK")}></img>
                        <img src="/images/instagramBlue.png" onClick={this.imgClick.bind(this, "https://www.instagram.com/theo.kremer/")}></img>
                    </div>
                ...
                <div className="text-wrapper">
                    <div className="sfproB basic-description">
                        <a className="ani lg-text">Hello,</a>
                        <br />
                        <a className="ani lg-text">my name is</a>
                        <br />
                        <a className="ani sfproSB name">Theo Kremer</a>
                        <br />
                        <a className="ani lg-text">as a motivated, hands-on, and collaborative<span className="blue"> Software Developer</span></a>
                        <br />
                        <a className="ani lg-text">flexible, persistent and innovative <span className="blue">Debugger</span></a>
                        <br />
                        <a className="ani blue lg-text">I find the best path to a solution</a>
                    </div>
                </div>
...
class Node {
    ...
    draw_initial() {
        ...
        this.size_animation = gsap.to(this.node_child, { duration: 0.35, width: `${this.width}vw`, height: `${this.width}vw`, paused: true, reversed: true })
        return this.node;
    }
